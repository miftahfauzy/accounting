...
async def migrate():
    ...
    lacl09 = await ChartOfAccount.create(account_number='2360', account_group_number='2000', account_name='State Payroll Taxes Payable')
    lacl10 = await ChartOfAccount.create(account_number='2370', account_group_number='2000', account_name='SUTA Payable')
    lacl11 = await ChartOfAccount.create(account_number='2380', account_group_number='2000', account_name='Local Payroll Taxes Payable')
    lacl12 = await ChartOfAccount.create(account_number='2390', account_group_number='2000', account_name='Income Taxes Payable')
    lacl13 = await ChartOfAccount.create(account_number='2400', account_group_number='2000', account_name='Other Taxes Payable')
    lacl14 = await ChartOfAccount.create(account_number='2410', account_group_number='2000', account_name='Employee Benefits Payable')
    lacl15 = await ChartOfAccount.create(account_number='2420', account_group_number='2000', account_name='Current Portion of Long-Term Debt')
    lacl16 = await ChartOfAccount.create(account_number='2440', account_group_number='2000', account_name='Deposits from Customers')
    lacl17 = await ChartOfAccount.create(account_number='2480', account_group_number='2000', account_name='Other Current Liabilities')
